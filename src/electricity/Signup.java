...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(173,216,236),2),"Create Account",TitledBorder.LEADING,TitledBorder.TOP,null,new Color(173,216,230)));
